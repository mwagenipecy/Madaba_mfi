<aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col shadow-sm h-screen fixed left-0 top-0 z-40 overflow-hidden">
    ...
    @php
        $user = auth()->user();
        $isLoanOfficer = $user && strtolower($user->role ?? '') === 'loan_officer';
        $isSuperAdmin = $user && $user->isSuperAdmin();
        $isOrgAdmin = $user && $user->isAdmin();
        ...
        $nav = [
            ...
            [
                ...
                'show'    => $isOrgAdmin && ! $isLoanOfficer,
                'items'   => [
                    ['type' => 'group', 'label' => 'Organizations', 'show' => $isSuperAdmin,
                    ...
                    ['type' => 'group', 'label' => 'System Management', 'show' => $isSuperAdmin,
            ...
            [
                ...
                'show'    => true,
                'items'   => [
                    ['type' => 'link', 'label' => 'Scoring', 'route' => 'scoring.index',
                     'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                    ['type' => 'link', 'label' => 'Collaterals', 'route' => 'collaterals.index',
                     'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
