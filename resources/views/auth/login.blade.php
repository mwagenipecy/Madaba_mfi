                ...
                <form class="space-y-4" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="pt-4">
                        <button 
                            type="submit" 
                            data-submit-btn
                            class="w-full py-3 px-4 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-300 disabled:opacity-75 disabled:cursor-not-allowed"
                        >
                            <span data-submit-label class="flex items-center justify-center">
                ...
                <form class="space-y-3" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="pt-3">
                        <button 
                            type="submit" 
                            data-submit-btn
                            class="w-full py-3 px-4 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-300 text-sm disabled:opacity-75 disabled:cursor-not-allowed"
                        >
                            <span data-submit-label class="flex items-center justify-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
