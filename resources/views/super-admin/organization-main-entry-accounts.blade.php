    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ $organization->name }} - Main Entry Accounts
            </h2>
            <div class="flex space-x-2">
                ...
                <a href="{{ route('super-admin.main-entry-account-balances') }}" 
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-orange-50 p-4 rounded-lg">
                            <div class="text-orange-600 text-sm font-medium">Avg Balance</div>
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-600">This organization doesn't have any main entry accounts configured yet.</p>
                        </div>
                    @endif
                </div>
            </div>
