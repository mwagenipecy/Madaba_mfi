<x-app-shell title="All Loans" header="Loan Management">
    <div class="py-6">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" class="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('loans.index') }}" class="ml-2 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                                Clear Filters
                            </a>
                        </div>
                    </form>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if($loan->status === 'approved')
                                                        <a href="{{ route('loans.disbursements') }}" class="text-yellow-600 hover:text-yellow-700">Disburse</a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
