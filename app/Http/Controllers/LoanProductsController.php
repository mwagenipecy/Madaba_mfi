...
class LoanProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'processing_fee_type' => 'nullable|in:fixed,percent',
            'processing_fee' => 'nullable|numeric|min:0' . ($request->processing_fee_type === 'percent' ? '|max:100' : ''),
        ...
        $loanProduct = LoanProduct::create([
            ...
            'processing_fee_type' => $request->processing_fee_type ?? 'fixed',
